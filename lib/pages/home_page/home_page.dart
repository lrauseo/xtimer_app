...
import 'package:xtimer_app/pages/bottom_sheet.dart';
import 'package:xtimer_app/pages/home_page/home_bloc.dart';
import 'package:xtimer_app/pages/home_page/home_events.dart';
import 'package:xtimer_app/pages/home_page/home_state.dart';
import 'package:xtimer_app/widgets/task_widget.dart';
import 'package:xtimer_app/pages/new_task_page.dart';
      ...
      body: Container(
        child: BlocBuilder<HomeEvent, HomeState>(
            ...
            builder: (BuildContext context, state) {
              if (state is HomeStateLoading) return Center(child: CircularProgressIndicator());
                ...
                if (tasks.isEmpty)
                  return Center(
                    child: Column(
                      ...
                      children: <Widget>[
                        Text('No Tasks', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                        Text('Add a new Task and it\nwill show up here.', textAlign: TextAlign.center)
                      ],
                    ),
                  );
