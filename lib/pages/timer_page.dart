...
import 'package:xtimer_app/widgets/rounded_button_widget.dart';
import 'dart:async';

import 'package:xtimer_app/widgets/wave_animation.dart';
...
class _TimerPageState extends State<TimerPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    final duration = Duration(days: 0, hours: task.hours!, minutes: task.minutes!, seconds: task.seconds!);
  ...
  Widget build(BuildContext context) {
    heightSize = new Tween(begin: begin, end: MediaQuery.of(context).size.height - 65).animate(
      CurvedAnimation(
        parent: _controller!,
          ...
          Align(
            ...
            child: Container(
              ...
              child: Center(
                child: Text(
                  task.title!,
                  style: TextStyle(fontSize: 24.0, color: Colors.white70, fontWeight: FontWeight.bold),
                ),
              ),
            ),
          ),
